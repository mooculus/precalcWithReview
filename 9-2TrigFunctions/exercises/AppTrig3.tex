...
\begin{image}
				\begin{tikzpicture}
					\begin{axis}[
				          ...
				          \addplot [dashed, smooth, domain=(0:360)] ({cos(x)},{sin(x)}); %% unit circle
				          \addplot [penColor2, smooth, domain=(0:45)] ({.1*cos(x)},{.1*sin(x)}); %% unit circle
					\addplot [penColor, smooth, domain=(0:135)] ({.15*cos(x)},{.15*sin(x)}); %% arc
					
					\addplot [penColor3, smooth, domain=(0:225)] ({.2*cos(x)},{.2*sin(x)}); %% arc
				          
				          \addplot [penColor4, smooth, domain=(0:315)] ({.25*cos(x)},{.25*sin(x)}); %% arc
...
%				          \addplot [penColor3,smooth, domain=(0:41)] ({.2*cos(x)},{.2*sin(x)});
				          \node at (axis cs:.707,.707) [anchor=west, penColor2] {$\theta_A$}; %\pi/4
				            \node at (axis cs:-.707,.707) [anchor=east] {$\theta_B$}; %3\pi/4
				          \node at (axis cs:-.707,-.707) [anchor=east, penColor3] {$\theta_C$}; %5\pi/4
				          \node at (axis cs:.707,-.707) [anchor=west, penColor4] {$\theta_D$}; %7\pi/4
