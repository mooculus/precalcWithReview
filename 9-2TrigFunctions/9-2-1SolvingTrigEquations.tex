...
\begin{tikzpicture}
	\begin{axis}[
          ...
          \addplot+[thick,penColor2,->] plot coordinates {(0,0) (.866,-0.5)}; %% 40 degrees
          \addplot+[thick,penColor,->] plot coordinates {(0,0) (-.866,-0.5)}; %% 40 degrees
          \addplot+[thick,penColor,->] plot coordinates {(0,0) (1,0)}; %% 40 degrees
          
          \addplot [penColor,smooth, domain=(0:210)] ({0.1*cos(x)},{0.1*sin(x)});
          \addplot [penColor2,smooth, domain=(0:330)] ({0.15*cos(x)},{0.15*sin(x)});
  	  \addplot[thick, penColor3, domain=(-1.1:1.1)]{-0.5} node[pos=0.4, below]{$y=-\frac{1}{2}$};          
         \end{axis}
\end{tikzpicture}
\end{image}
