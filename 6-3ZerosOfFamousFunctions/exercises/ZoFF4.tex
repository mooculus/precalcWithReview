...
\begin{exercise}
	...
	\begin{exercise}
		  ...
		  \]	
		\begin{exercise}
			The domain of $V$ is: \[ \left[ \answer{0} \, , \, \answer{6} \right] \]
			\begin{feedback}
				Think about what $x$ represents in the question. Can $x$ be negative? Can the width or length of the box be negative?
			\end{feedback}
		\end{exercise}	
	\end{exercise}
\end{exercise}
