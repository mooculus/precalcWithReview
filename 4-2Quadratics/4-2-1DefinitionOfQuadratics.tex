...
\begin{definition}
A \dfn{quadratic} is a function of the form
\[
f(x)=ax^2+bx+c
\]
where $a$, $b$, and $c$ are real numbers.  We say a quadratic written this way is in \dfn{Standard Form}.
\end{definition}

  The graph of a quadratic function $f(x)=ax^2+bx+c$ is called a \dfn{parabola}.   
