...
%				          \addplot [penColor3,smooth, domain=(0:41)] ({.2*cos(x)},{.2*sin(x)});
				          \node at (axis cs:.1,.08) [anchor=west, penColor2] {$\theta_R$}; %\pi/3
				            \node at (axis cs:-.15,.3) [anchor=west] {$\theta_A$}; %2\pi/3
				          \node at (axis cs:-.2,-.08) [anchor=west, penColor3] {$\theta_B$}; %4\pi/3
				          \node at (axis cs:.1,.-.08) [anchor=west, penColor4] {$\theta_C$}; %5\pi/3
