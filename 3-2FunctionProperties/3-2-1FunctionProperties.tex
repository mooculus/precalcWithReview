...
A function $f$ is\dfn{even} if $f(-x) = f(x)$ for all $x$ in the domain of $f$.
...
\begin{itemize}
\item If a function is even and the point $(x_1,y_1)$ is on the function graph, then the point $(-x_1,y_1)$ is also on the function graph.
\item If a function is even and the point $(x_1,y_1)$ is on the function graph, then the point $(-x_1,-y_1)$ is also on the function graph.
\end{itemize}
