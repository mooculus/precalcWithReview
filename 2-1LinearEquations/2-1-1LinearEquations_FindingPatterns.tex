...
Using the tables, find the \textbf{rate of change} in Oregon invasive cancer diagnoses between 2000 and 2010? 
\begin{center}
$
\begin{array}{||cc||}
\hline
...
\begin{definition} 
 If $(x_1,y_1)$ and $(x_2,y_2)$ are two data points with $x_1 \neq x_2$ from a set of two-variable data, then the \dfn{rate of change} between them is
...
\begin{tikzpicture}
    \begin{axis}[xlabel={year},
        ...
        \addplot[firstcurve,-] coordinates {(2000,17446) (2010,19727)} node[pos=0.40, pin=95:{rate $228.1\,\frac{\text{diagnoses}}{\text{year}}$}]{};
        \addplot[firstcurve,-] coordinates {(1999,17599) (2002,17887)} node[pos=0.5, pin=-91:{rate $96\,\frac{\text{diagnoses}}{\text{year}}$}]{};
