...
\end{image}
Reference: \link{https://www.columbus.gov/Templates/Detail.aspx?id=2147500472}
\begin{enumerate}
...
\end{example}
\begin{exploration}
According to True Car (\link{www.truecar.com}), a 2018 Toyota Camry (conventional) (29/41 MPG city/hwy) sells for an average of  \$22,030, and a Camry Hybrid (51/53 MPG city/hwy) sells for an average of \$26,247.  Currently gas prices are in the upper \$2 per gallon, so let's estimate about \$2.80 per gallon.
\begin{enumerate}
