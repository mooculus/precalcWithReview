...
For more information and examples about Slope-Intercept Form, see: \url{https://spot.pcc.edu/math/orcca/ed2/html/section-slope-intercept-form.html}.
...
\begin{tcolorbox}
\begin{definition}[Alternate Point-Slope Form of a Line]
When $x$ and  $y$ have a linear relationship where $m$ is the slope and $(x_0,y_0)$ is some specific point that the line passes through, one equation for this relationship is 
$$y=m(x-x_0)+y_0$$ 
and this equation is called the (alternate) point-slope form of the line. It is called this because the slope and one point on the line are immediately discernible from the numbers in the equation.
\end{definition}
\end{tcolorbox}
...
For more information and examples about Point-Slope Form, see: \url{https://spot.pcc.edu/math/orcca/ed2/html/section-point-slope-form.html}.
...
\begin{tcolorbox}
\begin{definition}[Standard Form of a Line]
 It is always possible to write an equation for a line in the form
$$Ax+By=C$$
where $A$,$B$, and $C$ are three numbers (each of which might be 0, although at least one of $A$ and $B$ must be nonzero). This form of a line equation is called standard form. 
\end{definition}
\end{tcolorbox}
...
For more information and examples about Point-Slope Form, see: \url{https://spot.pcc.edu/math/orcca/ed2/html/section-standard-form.html}.
...
\begin{tcolorbox}
\begin{definition}
A \textbf{horizontal line} is a line where all the $y$-values of the points are the same.  In this case, if the $y$-value is $y_0$, then the line can be written as 
$$y=y_0$$
\begin{center}
 \begin{tikzpicture}
    \begin{axis}[xmin=-1,xmax=9,width=0.47\linewidth,
...
\begin{tcolorbox}
\begin{definition}
A \textbf{vertical line} is a line where all the $x$-values of the points are the same.  In this case, if the $x$-value is $x_0$, then the line can be written as 
$$x=x_0$$
\begin{center}
 \begin{tikzpicture}
    \begin{axis}[xmin=-1,xmax=9,width=0.47\linewidth,
