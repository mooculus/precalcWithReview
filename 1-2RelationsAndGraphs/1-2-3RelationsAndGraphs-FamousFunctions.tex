...
\begin{example}
A prototypical example of a line is $$ \mbox{\huge $y=x.$}$$ 
...
Another very important type of function is the parabola.

\begin{example}
A prototypical example of a parabola is $$ \mbox{\huge $y=x^2.$}$$ 
...
In general, we can talk about exponential functions of the form $y=b^{x}$ where $b$ is a positive number.  You can play with changing the values of $b$ on the graph using Desmos and see how that changes the graph.  
