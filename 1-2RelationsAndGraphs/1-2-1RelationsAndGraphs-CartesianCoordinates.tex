...
\begin{itemize}
\item What are the coordinates of the bar? $(\answer[given]{3}$,$\answer[given]{-3})$
\item What are the coordinates of the gas station? $(\answer[given]{-2}$,$\answer[given]{-4})$
\item What are the coordinates of Carl's house? $(\answer[given]{0}$,$\answer[given]{0})$
\end{itemize}
\end{problem}
...
A Cartesian coordinate system is divided into four \dfn{quadrants} that are separated by the axes, as shown below. The quadrants are traditionally labeled with Roman numerals.
