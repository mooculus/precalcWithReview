...
%				          \addplot [penColor3,smooth, domain=(0:151)] ({.2*cos(x)},{.2*sin(x)});
				          \node at (axis cs:.2,.08) [anchor=west, penColor2] {$\theta_A$}; %\pi/6
				            \node at (axis cs:-.2,.2) [anchor=west] {$\theta_B$}; %5\pi/6
				          \node at (axis cs:-.35,-.08) [anchor=west, penColor3] {$\theta_C$}; %4\pi/3
				          \node at (axis cs:.2,.-.08) [anchor=west, penColor4] {$\theta_D$}; %11\pi/6
