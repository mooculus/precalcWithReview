...
%%%%%%%%%%%%%%%%%%%%%%
\item \begin{exercise}
Let $h(x) = e^{\frac{1}{3} + 2x}$ and $k(x) =\sqrt{x}+1$. \\
Then $h(x) \geq k(x)$ 
\begin{multipleChoice}
\choice{is always true.}
\choice{is true at a point.}
...
\end{multipleChoice}
\begin{exercise}
What is the interval on which $h(x) \geq k(x)$?\\
...
%%%%%%%%%%%%%%%%%%%%%%
\item \begin{exercise}
Let $f(x) = \cos\!\left(4\left(x+\frac{3\pi}{8}\right)\right)$ and $g(x) = \sin(4x)$. \\
Then $f(x)= g(x)$ 
\begin{multipleChoice}
...
%\end{multipleChoice}
%\begin{exercise}
%What is the interval on which $k(x) > h(x)$?\\
