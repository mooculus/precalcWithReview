...
\begin{definition}
In general, for a function of form $f(t) = ab^t$, we call $b$ the \dfn{growth factor}. \index{exponential function!growth factor}  Moreover, if $b = 1+r$, we call $r$ the \dfn{growth rate}. \index{exponential function!growth rate}  Whenever $b > 1$, we often say that the function $f$ is exhibiting \dfn(exponential growth}, wherease if $0 < b < 1$, we say $f$ exhibits \dfn{exponential decay}. \index{exponential function!exponential decay}
\end{definition}
