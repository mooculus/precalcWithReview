...
No matter the quadrant $\theta$ lies in, we can always construct a triangle by drawing this vertical side between the $x$-axis and the intersection point.
...
\begin{definition}
	...
	and the $x$-axis.
\end{definition}
If the terminal side of $\theta$ is along the $x$-axis (in either direction), we will have 
