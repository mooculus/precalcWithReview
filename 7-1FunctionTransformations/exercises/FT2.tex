...
<<<<<<< HEAD
If the graph of $y=f(x) = x\sin(x)$ is given in black below, which of the following graphs could be the graph of $y = f(x-2)$?
=======
...
<<<<<<< HEAD
     \addplot[samples=200,thick,domain=-7:7, color=blue]{(x+2)*sin(deg(x+2))};
     \addplot[samples=200,thick,domain=-7:7, color=red]{(x-2)*sin(deg(x-2))};
     \addplot[samples=200,thick,domain=-7:7, color=orange]{x*sin(deg(x)) + 1};
     \addplot[samples=200,thick,domain=-7:7, color=green]{x*sin(deg(x))-2};
=======
