...
\end{itemize}
\begin{image}
\includegraphics[width=0.8\linewidth]{inverse-trig-arctan-graph.png}
\end{image}
\end{callout}
...
\begin{image}
\includegraphics[width=.8\linewidth]{SecArcsecAxis.png}
\end{image}
\end{problem}
...
\end{itemize}
\begin{image}
\includegraphics[width=0.8\linewidth]{secArcsecGraphst.png}
\end{image}
\end{callout}
