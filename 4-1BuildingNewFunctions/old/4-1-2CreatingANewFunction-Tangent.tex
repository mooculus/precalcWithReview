...
\section{Introduction}
	Let us return to a couple of famous functions we've briefly met with before: sine and cosine. As a reminder, here is a graph of those functions with some
	...
	Call $f(x) = \sin(x) + \cos(x)$. What is the value of $f(0)$?  We know $f(0) = \sin(0) + \cos(0) = 0 + 1 = 1$. 
...
%			    clip=false,
	...
	You may recognize this, it will be one of our list of famous functions. This is tangent:
