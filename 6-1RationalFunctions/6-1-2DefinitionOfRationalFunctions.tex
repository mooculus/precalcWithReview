...
\begin{image}
\begin{tikzpicture}
    \begin{axis}[ymax=10, ymin=-10, ytick={-10,-8,...,10}]
      \addplot[samples=200,domain=-10:-3.05]{(x^3+2*x^2-11*x-20)/(x^3+3*x^2-4*x-12)};
      \addplot[samples=200,domain=-2.95:-2.05]{(x^3+2*x^2-11*x-20)/(x^3+3*x^2-4*x-12)};
      \addplot[samples=200,domain=-1.98:1.95]{(x^3+2*x^2-11*x-20)/(x^3+3*x^2-4*x-12)};
      \addplot[samples=200,domain=2.05:10]{(x^3+2*x^2-11*x-20)/(x^3+3*x^2-4*x-12)};
    \end{axis}
\end{tikzpicture}
\end{image}
