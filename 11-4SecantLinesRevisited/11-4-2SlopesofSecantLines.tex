...
\begin{callout}
  {\bf Definition:} The \dfn{difference quotient} of a function $y=f(x)$ at a point $a$ of its domain is the quantity $$\frac{f(a+h)-f(a)}{h},$$i.e., the average rate of change of $f$ on the interval $[a,a+h]$.
\end{callout}
